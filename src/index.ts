...
import { Bot, BotConfig } from './swap.js';
import {
  getToken,
  getWallet,
  logger,
...
import { DefaultTransactionExecutor, TransactionExecutor } from './txn_exe.js';
...
function printDetails(wallet: Keypair, quoteToken: Token, bot: Bot) {
  ...
  if (botConfig.useSnipeList) {
    ...
    logger.info(`Min mkt cap (in sol): ${botConfig.minMarketCap}`);
    logger.info(`Max mkt cap (in sol): ${botConfig.maxMarketCap}`);
  }
